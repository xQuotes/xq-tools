...
var aliasPath = {
  ...
  Urls : path.resolve('./src/route/url.js'),
  Api : path.resolve('./src/api/index.js'),
  ApiConfig: path.resolve('./src/api/config.js'),
...
entry.utils = ['Utils', 'Arr', 'Str', 'Obj', 'Fetch', 'Auth', 'Urls', 'Img']
...
var plugins = [
  ...
  new TransferWebpackPlugin([
    {from: path.resolve('./src/json'), to: path.resolve('./dist')},
    {from: path.resolve('./src/icon'), to: path.resolve('./dist')}
